...
> Personal AI Agent được viết lại bằng Rust để đạt hiệu năng cao và độ tin cậy tốt hơn
...
- **Tool System**: 20+ tools (file ops, web, exec, PDF, media, etc.)
- **MCP Integration**: Model Context Protocol support
- **Memory**: SQLite + LanceDB vector search (RAG)
